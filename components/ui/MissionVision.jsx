            ...
            <div className="relative">
              ...
              <div>
                ...
                <p className="mt-4 text-lg leading-relaxed text-gray-600">
                  Serve <span className="font-semibold text-emerald-600">200,000 smallholder farmers by 2030</span> through
                  science-led seed systems, providing certified climate-resilient seed potatoes,
                  training in climate-smart agricultural practices, and reliable market linkages.
                </p>
          ...
          >
            <div className="relative lg:mt-12">
              ...
              <div>
                ...
                <p className="mt-4 text-lg leading-relaxed text-gray-600">
                  Transform African agriculture through <span className="font-semibold text-orange-600">science-led seed systems</span>,
                  empowering smallholder farmers with climate-resilient potato varieties that
                  increase yields, improve nutrition, and build sustainable livelihoods.
                </p>
        ...
        >
          <div className="relative rounded-3xl bg-gray-50 p-8 lg:p-12">
            ...
            <p className="text-xl font-medium text-gray-900 lg:text-2xl">
              We believe every smallholder farmer deserves access to quality seeds
              and the knowledge to thrive in a changing climate.
            </p>
