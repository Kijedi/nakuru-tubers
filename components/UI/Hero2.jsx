  ...
  return (
    <div className="bg-[url('/images/pillars/5.jpg')] bg-cover bg-center lg:h-screen saturate-150 h-[400px] relative flex items-center">
      <div className="absolute z-10 max-w-4xl p-8 lg:p-20">
        ...
        <h1 className="font-[400] pb-2  text-orange-500 tracking-wider w-full text-xl lg:text-3xl capitalize">
        ...
        <Link
          alt="services"
          className=" bg-white hidden lg:inline-block hover:bg-white/80 duration-300 border text-orange-600 ease-in-out text-sm tracking-widest  px-4 py-2"
          href={"products"}
        >
          Our Products
        </Link>
