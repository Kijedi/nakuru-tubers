...
export default function Partner() {
  return (
    <div id="partner" className="bg-white py-20">
      <div className="w-full relative lg:max-w-5xl  grid grid-cols-5  mx-auto lg:shadow-2xl rounded-lg  text-black">
        ...
        <div className="col-span-5 lg:col-span-3 bg-orange-50 p-4 lg:rounded-r-lg">
          <div className="lg:p-16">
            ...
            <Link
              ...
              className="rounded-lg font-light text-sm px-4 py-3 hover:bg-emerald-600 duration-300 ease-in-out text-white bg-emerald-500"
            >
