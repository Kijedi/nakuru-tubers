...
export default function Change() {
  return (
    <div className="bg-white p-10  gap-8 flex flex-col items-center justify-center">
      <h3 class="font-black text-emerald-600 text-4xl  mb-[22px]">
        Our Theory of <span className="text-amber-600">Change</span>
      </h3>
      <div className="bg-gradient-to-tr text-3xl to-emerald-500 from-amber-500 text-white flex items-center justify-center font-bold h-20 w-20 rounded-full">
        1
      </div>
      <div className="max-w-5xl text-center">
        ...
        <p class="text-quote md:text-lead-lg text-lg text-gray-700 mb-2">
      ...
      <div className="bg-gradient-to-tr text-3xl to-emerald-500 from-amber-500 text-white flex items-center justify-center font-semibold h-20 w-20 rounded-full">
        2
      </div>
      <div className="max-w-5xl text-center">
        <h3 class="font-semibold text-emerald-600 text-3xl  mb-[22px]">
      ...
      <div className="bg-gradient-to-tr text-3xl mt-12 to-emerald-500 from-amber-500 text-white flex items-center justify-center font-semibold h-20 w-20 rounded-full">
        3
      </div>
      <div className="max-w-5xl text-center">
        <h3 class="font-semibold text-emerald-600 text-3xl  mb-[22px]">
